    ...
    <div class="container">
      <div class="blog-wrapper">
        <div class="blog-header">
          ...
          <img class="lazyload" src="{{ asset(App::environment('production') ? 'public/uploads/admin-blogs/thumbnail/'.$data->image : 'uploads/admin-blogs/thumbnail/'.$data->image) }}" data-srcset="{{ asset(App::environment('production') ? 'public/uploads/admin-blogs/extra-small/'.$data->image : 'uploads/admin-blogs/extra-small/'.$data->image) }} 250w, {{ asset(App::environment('production') ? 'public/uploads/admin-blogs/small/'.$data->image : 'uploads/admin-blogs/small/'.$data->image) }} 540w, {{ asset(App::environment('production') ? 'public/uploads/admin-blogs/medium/'.$data->image : 'uploads/admin-blogs/medium/'.$data->image) }} 720w, {{ asset(App::environment('production') ? 'public/uploads/admin-blogs/landscape/'.$data->image : 'uploads/admin-blogs/landscape/'.$data->image) }} 1140w" sizes="100vw" alt="{{ $data->title}}" width="100%">
              ...
              <div class="blog-related__wrapper">
                ...
                <div class="blog-related__card">
                  <div class="blog-related__image">
                    ...
                    <img class="lazyload" src="{{ asset(App::environment('production') ? 'public/uploads/admin-blogs/thumbnail/'.$post->image : 'uploads/admin-blogs/thumbnail/'.$post->image) }}" data-srcset="{{ asset(App::environment('production') ? 'public/uploads/admin-blogs/extra-small/'.$post->image : 'uploads/admin-blogs/extra-small/'.$post->image) }} 250w, {{ asset(App::environment('production') ? 'public/uploads/admin-blogs/small/'.$post->image : 'uploads/admin-blogs/small/'.$post->image) }} 540w, {{ asset(App::environment('production') ? 'public/uploads/admin-blogs/medium/'.$post->image : 'uploads/admin-blogs/medium/'.$post->image) }} 720w, {{ asset(App::environment('production') ? 'public/uploads/admin-blogs/landscape/'.$post->image : 'uploads/admin-blogs/landscape/'.$post->image) }} 1140w" sizes="100vw" alt="{{ $post->title }}" width="100%">
