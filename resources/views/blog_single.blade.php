    ...
    <div class="container">
      <div class="blog-wrapper">
        <div class="blog-header">
          ...
          <img class="lazyload" src="{{ asset(App::environment('production') ? 'public/uploads/admin-blogs/thumbnail/'.$data->image : 'uploads/admin-blogs/thumbnail/'.$data->image) }}" data-src="{{ asset(App::environment('production') ? 'public/uploads/admin-blogs/original/'.$data->image : 'uploads/admin-blogs/original/'.$data->image) }}" alt="{{ $data->title}}" width="100%">
              ...
              <div class="blog-related__wrapper">
                ...
                <div class="blog-related__card">
                  <div class="blog-related__image">
                    ...
                    <img class="lazyload" src="{{ asset(App::environment('production') ? 'public/uploads/admin-blogs/thumbnail/'.$post->image : 'uploads/admin-blogs/thumbnail/'.$post->image) }}" data-src="{{ asset(App::environment('production') ? 'public/uploads/admin-blogs/landscape/'.$post->image : 'uploads/admin-blogs/landscape/'.$post->image) }}" alt="{{ $post->title }}" width="100%">
